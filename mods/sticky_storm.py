...
def bsGetGames():
    return [StickyStormGame]

def bsGetLevels():
    return [bs.Level('Sticky Storm',displayName='${GAME}',gameType=StickyStormGame,settings={},previewTexName='rampagePreview'),
            bs.Level('Epic Sticky Storm',displayName='${GAME}',gameType=StickyStormGame,settings={'Epic Mode':True},previewTexName='rampagePreview')]

class StickyStormGame(bs.TeamGameActivity):
